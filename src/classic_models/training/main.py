...
from src.classic_models.training.utils import init_logger, set_seed
...
def main(args):
    ...
    test_dataset = load_and_cache_examples(args, mode="test.sh", vocab_list=vocab_list)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--do_eval", action="store_true", help="Whether to run eval on the test.sh set.")
    ...
    parser.add_argument("--encoder", default="textcnn", type=str,
    ...
    parser.add_argument("--embeddings_learning_rate", default=None,
                        type=float, help="The learning rate for Adam.")
    parser.add_argument("--learning_rate", default=5e-4,
                        type=float, help="The learning rate for Adam.")
    parser.add_argument("--classifier_learning_rate", default=None,
                        type=float, help="The learning rate for Adam.")

    parser.add_argument("--w2v_file", default=None, type=str,
