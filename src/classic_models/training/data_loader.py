...
class InputExample(object):
    """
    A single training/test.sh example for simple sequence classification.
...
def load_and_cache_examples(args, mode, vocab_list=None):
    ...
    if os.path.exists(cached_features_file):
        ...
        if mode == "train":
            ...
            examples = processor.get_examples("test.sh")
        else:
            raise Exception("For mode, Only train, dev, test.sh is available")
